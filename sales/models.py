...
class InvoiceDetail(models.Model):
    ...
    def __str__(self):
        ...
        elif self.item_type == 'package' and self.service_package:
            item_name = self.service_package.name
        elif self.item_type == 'product' and self.product:
            item_name = self.product.name
        elif self.item_type == 'gift_card' and self.gift_card:
            item_name = self.gift_card.name
